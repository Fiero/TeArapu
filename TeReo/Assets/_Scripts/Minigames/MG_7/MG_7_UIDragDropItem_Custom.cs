...
public class MG_7_UIDragDropItem_Custom : MonoBehaviour
{
	public Minigame_7_Fishing MG7;
...
#region Common functionality
	...
	protected virtual void Awake(){
		MG7 = GameObject.Find("Minigame_7").GetComponent<Minigame_7_Fishing>();
	}
	...
	void OnDragStart ()
	{
		...
		if (cloneOnDrag)
		{
			...
			MG_7_UIDragDropItem_Custom item = clone.GetComponent<MG_7_UIDragDropItem_Custom>();
			item.Start();
	...
	protected virtual void OnDragDropRelease (GameObject surface)
	{
		...
		if (!cloneOnDrag)
		{
			...
			//Is there a MG_7_Target? Is this a fish?
			MG_7_Target target = surface ? surface.GetComponent<MG_7_Target>() : null;
			if(target != null){
				print("I AM :" + target.GetWord());

			//  checkminigame
				//bool isCorrect = true;

				int numCorrect = MG7.CheckAnswer( target.GetWord() );
				...
				if(numCorrect == 0){
					...
					print("DRAGDROP: CORRECT LAST ONE");
				}

				else{
					print("DRAGDROP: CORRECT");
					//carry me off, disable hook
